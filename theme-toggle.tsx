...
export function ThemeToggle() {
  ...
  return (
    <Button
      variant="ghost"
      size="icon"
      className="glass-button rounded-full w-10 h-10 hover:glow-turquoise focus:ring-2 focus:ring-turquoise focus:ring-offset-2"
      onClick={() => setTheme(theme === "light" ? "dark" : "light")}
      aria-label={`Theme toggle: Currently in ${theme} mode. Click to switch to ${theme === "light" ? "dark" : "light"} mode`}
