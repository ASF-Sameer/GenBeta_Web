        ...
        <nav className="w-full px-3 sm:px-4 lg:px-6" role="navigation" aria-label="Main navigation">
          <div className="flex items-center justify-between h-12 sm:h-14 lg:h-16 max-w-7xl mx-auto">
            <TransitionLink
              href="/"
              className={cn(
                "flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#00B5AD] focus:ring-offset-2 focus:ring-offset-[#1E1A5F] shrink-0",
                isWhiteSection
            ...
            <button
              className={cn(
                "w-10 h-10 flex items-center justify-center rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-[#00B5AD] focus:ring-offset-2 focus:ring-offset-[#1E1A5F]",
                isWhiteSection
          ...
          <div className="relative z-10 w-[85vw] max-w-sm" onClick={(e) => e.stopPropagation()}>
            <div className="bg-gradient-to-b from-[#1E1A5F] to-[#0057B8]/90 backdrop-blur-2xl border border-white/15 rounded-3xl p-6 shadow-2xl shadow-black/40">
              ...
              <div className="space-y-1">
                {navLinks.map((link) => (
                  <a
                    ...
                    className="flex items-center gap-4 px-4 py-4 rounded-2xl text-base font-medium text-white hover:bg-white/10 hover:text-[#00B5AD] active:bg-white/15 transition-all focus:outline-none focus:ring-2 focus:ring-[#00B5AD] focus:ring-offset-2 focus:ring-offset-[#1E1A5F]"
                  >
              ...
              <div className="mt-5 pt-4 border-t border-white/10 px-2">
                <p className="text-xs text-white/60 text-center">Reframe at Zain</p>
              </div>
            </div>
          </div>
        </div>
