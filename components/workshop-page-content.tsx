...
import { BookCard } from "@/components/book-popup-modal"
  ...
  return (
    <div className="relative">
      ...
      {workshop.readingJourneySection && workshop.readingJourneySection.books && workshop.readingJourneySection.books.length > 0 && (
        <ReadingJourneySection data={workshop.readingJourneySection} />
      )}
...
function ReadingJourneySection({ data }: { data: NonNullable<WorkshopData['readingJourneySection']> }) {
